...
func sync_visual(cell_size: Vector2, fill_color: Color, outline_color: Color) -> void:
	debug_cell_size = cell_size
...
func _sync_position_from_cell() -> void:
	...
	_is_syncing = true
	position = (Vector2(cell.x, cell.y) + Vector2(0.5, 0.5)) * _get_resolved_cell_size()
	_is_syncing = false
...
func _sync_cell_from_position() -> void:
	...
	var resolved_cell_size := _get_resolved_cell_size()
